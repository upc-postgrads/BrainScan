...
read_path ='/Users/aitorjara/Desktop/Task01_BrainTumour/imagesTs/'
write_path ='/Users/aitorjara/Desktop/CleanSlices/imagesTs/'
patient = 0
    ...
    if filename.endswith("nii.gz"):
        ...
        for contrast in range(data.shape[3]):
            for slices in range(data.shape[2]):
                slice_name = 'P' + str(patient + 1) + 'C' + str(contrast + 1) + '_' + str(slices + 1) + format
