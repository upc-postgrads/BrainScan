...
class GenerateTFRedord:
    ...
    SLICE_START =0
    SLICE_END = 154
    PATIENT_START_TRAINING =392
    PATIENT_END_TRAINING  = 410
    PATIENT_START_TEST =735
    ...
    def generate_tfrecords_for_training(self):
        ...
        for i,j in enumerate(list(range(self.PATIENT_START_TRAINING, int(self.PATIENT_END_TRAINING * (1 - percent_for_validation/100) + 1)))):
            print("got there")
            print(self.PATIENT_START_TRAINING, int(self.PATIENT_END_TRAINING * (1 - percent_for_validation/100) + 1))
...
if __name__ == '__main__':
    ...
    imagePathTR = "C:/Users/Eduard/Desktop/Task01_BrainTumour/imagesTr"
    labelPathTR = "C:/Users/Eduard/Desktop/Task01_BrainTumour/labelsTr"
    imagePathTS = "C:/Users/Eduard/Desktop/Task01_BrainTumour/imagesTs"
    outputDir = "C:/Users/Eduard/Desktop/BrainTumorImages/Generated"
    number_of_volumes_to_process=19
    percent_for_validation=1
